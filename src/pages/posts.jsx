                    ...
                    {[...Array(totalPages)].map((_, index) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-1 text-sm font-medium rounded cursor-pointer ${currentPage === pageNumber ? 'bg-gray-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                            >
                                {pageNumber}
                            </button>
                        );
